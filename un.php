<?php
/*نسخه دیتا بیس سلف اویل
لاین های 98.268.269 ادیت بشه کد دیتا بیس اخر سورس مشاهده کنید*/
...
*/
    try {
      ...
      $step = $data['adminStep'];
      $op = @$update['pts'];
      $url = "https://zedbazi.power-server.ir/self"; // آدرس پوشه ای که سورس داخلشه رو بزارید
      $helper = "@Akkaoqoqjwkqbot"; // آیدی ربات هلپر همراه با @            
      ...
      $dastoorat =
        [
          ...
          "coding on",
              ...
              'peer'       => $peer,
              'message'    => "ʸᵒᵘʳ ʳᵒᵇᵒᵗ 𖢊 ᶤᶳ [ᵒᶰˡᶤᶰᵉ](https://t.me/mrsilent09)",  /* دست نزنید از کار میفته */
              'parse_mode' => 'markdown',
               'no_webpage' => true
             , 'id' => $messageId
            ]);
  ...
  'peer' => [
    ...
    'db'            => [
        ...
        'mysql' => [
            'host'     => 'localhost',
            'port'     => '3306',
            'user'     => 'hrwocesc_Shhshshshshh',
            'password' => '09921374858x',
            'database' => 'hrwocesc_Shshahshshshh',
        ]
    ] 
];
